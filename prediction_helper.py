...
model_young = joblib.load("facts/model_young.joblib")
model_old = joblib.load("facts/model_old.joblib")
scaler_young = joblib.load("facts/scaler_young.joblib")
scaler_old = joblib.load("facts/scaler_old.joblib")
...
def predict(input_dict):
    ...
    if input_dict['age'] < 25:
        ...
        final_premium = model_old.predict(processed_data)
